...
function deletePart(partName) {
    ...
    // Add functionality to delete part
}

function deleteLesson(lessonName) {
    console.log('Deleting lesson:', lessonName);
    // Add functionality to delete lesson
}

function deleteComment(commentAuthor) {
    console.log('Deleting comment by:', commentAuthor);
